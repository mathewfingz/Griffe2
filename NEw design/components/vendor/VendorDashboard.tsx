...
const salesData = [
  { name: 'Ene', ventas: 4000, pedidos: 24, visitantes: 1200 },
  { name: 'Feb', ventas: 3000, pedidos: 13, visitantes: 1100 },
  { name: 'Mar', ventas: 5000, pedidos: 35, visitantes: 1400 },
  { name: 'Abr', ventas: 4500, pedidos: 28, visitantes: 1300 },
  { name: 'May', ventas: 6000, pedidos: 42, visitantes: 1600 },
  { name: 'Jun', ventas: 7200, pedidos: 48, visitantes: 1800 },
];

const productPerformance = [
  { name: 'Smartphone XYZ', ventas: 1200, stock: 45, categoria: 'Electrónicos' },
  { name: 'Auriculares Bluetooth', ventas: 800, stock: 23, categoria: 'Electrónicos' },
  { name: 'Camiseta Vintage', ventas: 650, stock: 78, categoria: 'Moda' },
  { name: 'Reloj Deportivo', ventas: 500, stock: 12, categoria: 'Deportes' },
  { name: 'Libro de Cocina', ventas: 320, stock: 34, categoria: 'Libros' },
];
...
const recentOrders = [
  { id: '001', cliente: 'María García', producto: 'Smartphone XYZ', monto: 599, estado: 'entregado', fecha: '2024-01-15' },
  { id: '002', cliente: 'Carlos López', producto: 'Auriculares Bluetooth', monto: 89, estado: 'enviado', fecha: '2024-01-14' },
  { id: '003', cliente: 'Ana Martínez', producto: 'Camiseta Vintage', monto: 29, estado: 'procesando', fecha: '2024-01-14' },
  { id: '004', cliente: 'Luis Rodríguez', producto: 'Reloj Deportivo', monto: 199, estado: 'pendiente', fecha: '2024-01-13' },
];
