...
const platformStats = {
  ...
  totalOrders: 12893,
  avgCommission: 8.5,
  platformRevenue: 241845
};

const topVendors = [
  { id: '1', name: 'TechStore Pro', email: 'tech@store.com', sales: 125000, commission: 12500, products: 89, status: 'active', tier: 'Platino' },
  { id: '2', name: 'Fashion Hub', email: 'fashion@hub.com', sales: 98000, commission: 11760, products: 156, status: 'active', tier: 'Oro' },
  { id: '3', name: 'Sports World', email: 'sports@world.com', sales: 78000, commission: 7800, products: 234, status: 'active', tier: 'Oro' },
  { id: '4', name: 'Home Essentials', email: 'home@essentials.com', sales: 65000, commission: 9750, products: 98, status: 'pending', tier: 'Plata' },
  { id: '5', name: 'Beauty Corner', email: 'beauty@corner.com', sales: 52000, commission: 9360, products: 67, status: 'active', tier: 'Plata' }
];

const salesData = [
  { month: 'Ene', ventas: 180000, vendedores: 145, pedidos: 890 },
  { month: 'Feb', ventas: 210000, vendedores: 167, pedidos: 1020 },
  { month: 'Mar', ventas: 240000, vendedores: 189, pedidos: 1150 },
  { month: 'Abr', ventas: 280000, vendedores: 201, pedidos: 1340 },
  { month: 'May', ventas: 320000, vendedores: 234, pedidos: 1560 },
  { month: 'Jun', ventas: 365000, vendedores: 267, pedidos: 1780 }
];

const categoryData = [
  { name: 'Electrónicos', value: 35, revenue: 995000, color: '#8884d8' },
  { name: 'Moda', value: 28, revenue: 798000, color: '#82ca9d' },
  { name: 'Hogar', value: 20, revenue: 570000, color: '#ffc658' },
  { name: 'Deportes', value: 10, revenue: 285000, color: '#ff7300' },
  { name: 'Belleza', value: 7, revenue: 199500, color: '#00ff88' }
];

const recentActivity = [
  { id: '1', type: 'new_vendor', vendor: 'Digital Solutions', message: 'Nuevo vendedor registrado', time: '5 min', status: 'pending' },
  { id: '2', type: 'payout', vendor: 'TechStore Pro', message: 'Pago procesado: €1,250', time: '12 min', status: 'completed' },
